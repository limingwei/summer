...
import li.mongo.driver.model.Like;
...
public class Parsers {
    ...
    public static Object getRight(Expression expression, MongoPreparedStatement preparedStatement) {
        if (expression instanceof EqualsTo) {// =
            ...
            return MapUtil.toMap(QueryOperators.NE, getRightValue((NotEqualsTo) expression, preparedStatement));
        } else if (expression instanceof MinorThan) {
            return MapUtil.toMap(QueryOperators.LT, getRightValue((MinorThan) expression, preparedStatement));
        } else if (expression instanceof MinorThanEquals) {
            return MapUtil.toMap(QueryOperators.LTE, getRightValue((MinorThanEquals) expression, preparedStatement));
        } else if (expression instanceof GreaterThan) {
            return MapUtil.toMap(QueryOperators.GT, getRightValue((GreaterThan) expression, preparedStatement));
        } else if (expression instanceof GreaterThanEquals) {
            return MapUtil.toMap(QueryOperators.GTE, getRightValue((GreaterThanEquals) expression, preparedStatement));
        } else if (expression instanceof InExpression) {
            return MapUtil.toMap(((InExpression) expression).isNot() ? QueryOperators.NIN : QueryOperators.IN, getRightValue((InExpression) expression, preparedStatement));
        } else if (expression instanceof IsNullExpression) {
            return null;
        } else {
