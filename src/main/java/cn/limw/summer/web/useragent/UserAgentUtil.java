package cn.limw.summer.web.useragent;
...
public class UserAgentUtil {
    ...
    public static UserAgent getUserAgent(String userAgentStr) {
        if (StringUtil.isEmpty(userAgentStr)) {
            return null;
        }

        if (userAgentStr.contains("Windows")) {//主流应用靠前  
            /**
             * ******************
             * 台式机 Windows 系列
             * ******************
            ...
            if (userAgentStr.contains("Windows NT 6.2")) {//Windows 8  
                return judgeBrowser(userAgentStr, "Windows", "8", null);//判断浏览器  
            } else if (userAgentStr.contains("Windows NT 6.1")) {//Windows 7  
                return judgeBrowser(userAgentStr, "Windows", "7", null);
            } else if (userAgentStr.contains("Windows NT 6.0")) {//Windows Vista  
                return judgeBrowser(userAgentStr, "Windows", "Vista", null);
            } else if (userAgentStr.contains("Windows NT 5.2")) {//Windows XP x64 Edition  
                return judgeBrowser(userAgentStr, "Windows", "XP", "x64 Edition");
            } else if (userAgentStr.contains("Windows NT 5.1")) {//Windows XP  
                return judgeBrowser(userAgentStr, "Windows", "XP", null);
            } else if (userAgentStr.contains("Windows NT 5.01")) {//Windows 2000, Service Pack 1 (SP1)  
                return judgeBrowser(userAgentStr, "Windows", "2000", "SP1");
            } else if (userAgentStr.contains("Windows NT 5.0")) {//Windows 2000  
                return judgeBrowser(userAgentStr, "Windows", "2000", null);
            } else if (userAgentStr.contains("Windows NT 4.0")) {//Microsoft Windows NT 4.0  
                return judgeBrowser(userAgentStr, "Windows", "NT 4.0", null);
            } else if (userAgentStr.contains("Windows 98; Win 9x 4.90")) {//Windows Millennium Edition (Windows Me)  
                return judgeBrowser(userAgentStr, "Windows", "ME", null);
            } else if (userAgentStr.contains("Windows 98")) {//Windows 98  
                return judgeBrowser(userAgentStr, "Windows", "98", null);
            } else if (userAgentStr.contains("Windows 95")) {//Windows 95  
                return judgeBrowser(userAgentStr, "Windows", "95", null);
            } else if (userAgentStr.contains("Windows CE")) {//Windows CE  
                return judgeBrowser(userAgentStr, "Windows", "CE", null);
            }
            ...
            if (userAgentStr.contains("iPod")) {
                return judgeBrowser(userAgentStr, "iPod", null, null);//判断浏览器  
            }
        }
        log.debug("getUserAgent() unknown userAgentStr={}", userAgentStr);
        return null;
    }
    ...
    private static UserAgent judgeBrowser(String userAgent, String platformType, String platformSeries, String platformVersion) {
        ...
        } else if (userAgent.contains("Trident") && userAgent.contains("rv") && userAgent.contains("Gecko")) {
        ...
        log.debug("judgeBrowser() unknown userAgent={}, platformType={}, platformSeries={}, platformVersion={}", userAgent, platformType, platformSeries, platformVersion);
        return null;
    }
}
