...
/**
 * @author li
 * @version 1 (2015年3月3日 上午9:53:14)
 * @since Java7
 * @see org.apache.log4j.DailyRollingFileAppender
 */
public class AbstractDailyRollingFileAppender extends FileAppender {
     ...
     */
    public AbstractDailyRollingFileAppender() {}
     ...
     */
    public AbstractDailyRollingFileAppender(Layout layout, String filename, String datePattern) throws IOException {
