...
/**
 * 复制 com.alibaba.druid.wall.WallFilter
 * @author li
 * @version 1 (2015年1月16日 下午3:45:55)
 * @since Java7
 */
public class AbstractWallFilter extends FilterAdapter implements WallFilterMBean {
    private final static Log LOG = LogFactory.getLog(AbstractWallFilter.class);
    ...
    public void setWallProvider(WallProvider wallProvider) {
        this.wallProvider = wallProvider;
    }

    public AbstractWallFilter() {
        configFromProperties(SystemUtil.getProperties());
    }
    ...
    public synchronized void init(DataSourceProxy dataSource) {
        ...
        if (JdbcUtils.MYSQL.equals(dbType) || //
            ...
            setWallProvider(new MySqlWallProvider(config));
            ...
            setWallProvider(new OracleWallProvider(config));
    ...
    public void clearProviderCache() {
        if (getWallProvider() != null) {
            getWallProvider().clearCache();
        }
    }
    ...
    public Set<String> getProviderWhiteList() {
        ...
        return getWallProvider().getWhiteList();
    }
    ...
    public int[] statement_executeBatch(FilterChain chain, StatementProxy statement) throws SQLException {
        ...
        try {
            ...
            if (sqlStat != null) {
                getWallProvider().addUpdateCount(sqlStat, updateCount);
            }
    ...
    public String check(String sql) throws SQLException {
        WallCheckResult checkResult = getWallProvider().check(sql);
    ...
    public boolean isWrapperFor(FilterChain chain, Wrapper wrapper, Class<?> iface) throws SQLException {
        if (config.isDoPrivilegedAllow() && getWallProvider().ispPrivileged()) {
            return chain.isWrapperFor(wrapper, iface);
        }

        return this.getWallProvider().getConfig().isWrapAllow() && chain.isWrapperFor(wrapper, iface);
    }
    ...
    public <T> T unwrap(FilterChain chain, Wrapper wrapper, Class<T> iface) throws SQLException {
        ...
        if (!this.getWallProvider().getConfig().isWrapAllow()) {
            return null;
        }
    ...
    public DatabaseMetaData connection_getMetaData(FilterChain chain, ConnectionProxy connection) throws SQLException {
        ...
        if (!this.getWallProvider().getConfig().isMetadataAllow()) {
            if (isLogViolation()) {
    ...
    public void resultSet_close(FilterChain chain, ResultSetProxy resultSet) throws SQLException {
        ...
        getWallProvider().addFetchRowCount(sqlStat, fetchRowCount);
    }
    ...
    public java.io.InputStream resultSet_getBinaryStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
    ...
    public java.io.Reader resultSet_getCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
    ...
    public java.sql.Date resultSet_getDate(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
        return chain.resultSet_getDate(resultSet, resultSet.getPhysicalColumn(columnIndex));
    }

    public java.sql.Date resultSet_getDate(FilterChain chain, ResultSetProxy resultSet, int columnIndex, Calendar cal) throws SQLException {
    ...
    public java.io.Reader resultSet_getNCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
    ...
    public Object resultSet_getObject(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.util.Map<String, Class<?>> map) throws SQLException {
    ...
    public java.sql.Time resultSet_getTime(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
        return chain.resultSet_getTime(resultSet, resultSet.getPhysicalColumn(columnIndex));
    }

    public java.sql.Time resultSet_getTime(FilterChain chain, ResultSetProxy resultSet, int columnIndex, Calendar cal) throws SQLException {
        return chain.resultSet_getTime(resultSet, resultSet.getPhysicalColumn(columnIndex), cal);
    }

    public java.sql.Timestamp resultSet_getTimestamp(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
        return chain.resultSet_getTimestamp(resultSet, resultSet.getPhysicalColumn(columnIndex));
    }

    public java.sql.Timestamp resultSet_getTimestamp(FilterChain chain, ResultSetProxy resultSet, int columnIndex, Calendar cal) throws SQLException {
        return chain.resultSet_getTimestamp(resultSet, resultSet.getPhysicalColumn(columnIndex), cal);
    }

    public java.net.URL resultSet_getURL(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
        return chain.resultSet_getURL(resultSet, resultSet.getPhysicalColumn(columnIndex));
    }

    public java.io.InputStream resultSet_getUnicodeStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex) throws SQLException {
        return chain.resultSet_getUnicodeStream(resultSet, resultSet.getPhysicalColumn(columnIndex));
    }

    public void resultSet_updateArray(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Array x) throws SQLException {
        chain.resultSet_updateArray(resultSet, resultSet.getPhysicalColumn(columnIndex), x);
    }

    public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.InputStream x) throws SQLException {
        chain.resultSet_updateAsciiStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x);
    }

    public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.InputStream x, int length) throws SQLException {
        chain.resultSet_updateAsciiStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x, length);
    }

    public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.InputStream x, long length) throws SQLException {
        chain.resultSet_updateAsciiStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x, length);
    }
    ...
    public void resultSet_updateBinaryStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.InputStream x) throws SQLException {
        chain.resultSet_updateBinaryStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x);
    }

    public void resultSet_updateBinaryStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.InputStream x, int length) throws SQLException {
        chain.resultSet_updateBinaryStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x, length);
    }

    public void resultSet_updateBinaryStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.InputStream x, long length) throws SQLException {
        chain.resultSet_updateBinaryStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x, length);
    }
    ...
    public void resultSet_updateBlob(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Blob x) throws SQLException {
    ...
    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.Reader x) throws SQLException {
        chain.resultSet_updateCharacterStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x);
    }

    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.Reader x, int length) throws SQLException {
        chain.resultSet_updateCharacterStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x, length);
    }

    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.Reader x, long length) throws SQLException {
        chain.resultSet_updateCharacterStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x, length);
    }

    public void resultSet_updateClob(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Clob x) throws SQLException {
    ...
    public void resultSet_updateDate(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Date x) throws SQLException {
    ...
    public void resultSet_updateNCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.Reader x) throws SQLException {
        chain.resultSet_updateNCharacterStream(resultSet, resultSet.getPhysicalColumn(columnIndex), x);
    }

    public void resultSet_updateNCharacterStream(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.io.Reader x, long length) throws SQLException {
    ...
    public void resultSet_updateRef(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Ref x) throws SQLException {
    ...
    public void resultSet_updateTime(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Time x) throws SQLException {
        chain.resultSet_updateTime(resultSet, resultSet.getPhysicalColumn(columnIndex), x);
    }

    public void resultSet_updateTimestamp(FilterChain chain, ResultSetProxy resultSet, int columnIndex, java.sql.Timestamp x) throws SQLException {
    ...
    public boolean resultSet_next(FilterChain chain, ResultSetProxy resultSet) throws SQLException {
        ...
        TenantCallBack callback = getWallProvider().getConfig().getTenantCallBack();
    ...
    public long getViolationCount() {
        return this.getWallProvider().getViolationCount();
    }

    public void resetViolationCount() {
        this.getWallProvider().reset();
    }

    public void clearWhiteList() {
        this.getWallProvider().clearCache();
    }

    public boolean checkValid(String sql) {
        return getWallProvider().checkValid(sql);
    }
    ...
    private void preprocessResultSet(ResultSetProxy resultSet) throws SQLException {
        ...
        TenantCallBack tenantCallBack = getWallProvider().getConfig().getTenantCallBack();
        String tenantTablePattern = getWallProvider().getConfig().getTenantTablePattern();
            ...
            if (StringUtils.isEmpty(hiddenColumn) || StringUtils.isEmpty(tenantColumn)) {
                if (tableName == null || ServletPathMatcher.getInstance().matches(tenantTablePattern, tableName)) {
                    if (StringUtils.isEmpty(hiddenColumn)) {
                        hiddenColumn = getWallProvider().getConfig().getTenantColumn();
                    }

                    if (StringUtils.isEmpty(tenantColumn)) {
                        tenantColumn = getWallProvider().getConfig().getTenantColumn();
                    }
                }
            }
