...
public class CustomDefaultFilterChainManager extends DefaultFilterChainManager {
    ...
    public FilterChain proxy(FilterChain original, List<String> chainNames) {
        //        log.info("proxy {}", Mvcs.getRequestURI());
    ...
    public void addToChain(String chainName, String filterName, String chainSpecificFilterConfig) {
        log.info("addToChain chainName={}, filterName={}, chainSpecificFilterConfig={}", chainName, filterName, chainSpecificFilterConfig);
        super.addToChain(chainName, filterName, chainSpecificFilterConfig);
    }
}