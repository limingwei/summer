...
/**
 * @author li
 * @version 1 (2014年12月25日 下午3:12:46)
 * @since Java7
 */
public abstract class FailbackRegistry extends AbstractRegistry {
    ...
    protected void recover() throws Exception {
        Set<URL> recoverRegistered = new HashSet<URL>(getRegistered());// register
        ...
        Map<URL, Set<NotifyListener>> recoverSubscribed = new HashMap<URL, Set<NotifyListener>>(getSubscribed()); // subscribe
